            ...
            <div className="hidden lg:flex items-center space-x-1 ml-4 flex-1 justify-end pr-4">
              ...
              {rolNormalizado === 'admin' && (
                <>
                  ...
                  <Link href="/admin/usuarios" className="hover:bg-blue-800 px-3 py-2 rounded-md text-[11px] font-bold uppercase transition tracking-wider">Usuarios</Link> 
                </>
              )}
            </div>
              ...
              <>
                ...
                {rolNormalizado === 'admin' && (
                  <>
                    ...
                    <Link href="/admin/resultados" className="block px-3 py-2 rounded-md text-sm font-bold bg-emerald-600 mt-2 uppercase tracking-wider">🔢 Resultados Rápidos</Link>
                  </>
                )}
